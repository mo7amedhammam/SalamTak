...
//            MapView(Title: self.$title, subTitle: self.$subtitle,longtude:$clinicLocation.Longitude.double() ,latitude:$clinicLocation.Latitude.double())
        ...
        .onAppear(perform: {
//            self.longtude = coordinate?.longitude ?? 30.32333232
//            self.latitude = coordinate?.latitude ?? 31.065656565
            print("on appear")

//            print(coordinate?.longitude ?? 2.2)
//            print(coordinate?.latitude ?? 2.2)
        })
        .onDisappear(perform: {
            print("on disappear")
            patientLocation.Longitude = longtude
            patientLocation.Latitude = latitude
            print(longtude)  // get new value ok
            print(latitude)
            print(patientLocation.Longitude)
            print(patientLocation.Latitude)
        })
    }
}
...
//                }
//
//                let pinImage = UIImage(systemName: "mappin.and.ellipse")?.withTintColor(.red)
...
//            print(view.annotation?.coordinate.latitude ?? 51655554)
            ...
            print(self.parent.longtude)
            print(self.parent.latitude)
