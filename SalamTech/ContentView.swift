...
//            PatientProfile()
        ...
        .onAppear(perform: {
            ...
            Helper.setAccessToken(access_token: "Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1bmlxdWVfbmFtZSI6IjAxMTEwMDAwMDAwIiwibmFtZWlkIjoiMzU5MiIsImp0aSI6ImIwOTllZmFiLTYxYmItNDk3OC05YTliLThlMzQxN2NlZjMzNCIsImV4cCI6MTY1MjQzNDU3OSwiaXNzIjoiU2FsYW1UZWNoQDIwMjEiLCJhdWQiOiJTYWxhbVRlY2hAMjAyMSJ9.B04hz7f0WIdwfJi1053Q0JaBv9xGwHgtEBDDP3IskDo")
        })
