...
final class GetBloodTypeApiService{

static func GetBloodType( completion: @escaping ( Bool , ModelBloodType?, String?) -> ()) {
    
    let url = URLs().GetBloodTypes
        let header:HTTPHeaders = ["Authorization":Helper.getAccessToken()]
    
    AF.request(url, method: .get,parameters: nil ,encoding: JSONEncoding.default ,headers: header )
        .validate(statusCode: 200..<500)
        .responseDecodable(completionHandler: { ( response : DataResponse<ModelBloodType?, AFError>) in
