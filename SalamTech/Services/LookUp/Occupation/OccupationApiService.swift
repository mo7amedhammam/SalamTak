...
final class GetOccupationApiService{

static func GetOccupation( completion: @escaping ( Bool , ModelOccupation?, String?) -> ()) {
    
    let url = URLs().GetOccupation
        let header:HTTPHeaders = ["Authorization":Helper.getAccessToken()]
    
    AF.request(url, method: .get,parameters: nil ,encoding: JSONEncoding.default ,headers: header )
        .validate(statusCode: 200..<500)
        .responseDecodable(completionHandler: { ( response : DataResponse<ModelOccupation?, AFError>) in
