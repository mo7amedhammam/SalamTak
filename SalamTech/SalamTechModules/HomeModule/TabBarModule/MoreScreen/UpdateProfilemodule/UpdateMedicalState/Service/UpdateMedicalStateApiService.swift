...
final class UpdateMedicalStateApiService {
    
    static func UpdatePatientMedicalState( passedparameters : [String:Any],
                                     completion: @escaping ( Bool , ModelGetMedicalState?, String?) -> ()) {
        
        let url = URLs().PatientUpdateMedicalInfo
        ...
        AF.request(url, method: .post,parameters: parameters ,encoding: JSONEncoding.default ,headers: header )
            ...
            .responseDecodable(completionHandler: { ( response : DataResponse<ModelGetMedicalState?, AFError>) in
            ////////////////////////////////
...
//                    Helper.setUserimage(userImage: URLs.BaseUrl+"\(model?.Data?.Image ?? "")")
    ...
    static func GetPatientMedicalState( completion: @escaping ( Bool , ModelGetMedicalState?, String?) -> ()) {
        
        let url = URLs().PatientGetMedicalInfo
