...
final class CreatePtAppointmentApi {

static func CreateAppointment(parameters:[String:Any] ,completion: @escaping ( Bool , ModelCreateAppointment?, String?) -> ()) {
    
    let url = URLs().CreatePatientAppointment
    ...
    AF.request(url, method: .post,parameters: parameters ,encoding: JSONEncoding.default ,headers: header )
        ...
        .responseDecodable(completionHandler: { ( response : DataResponse<ModelCreateAppointment?, AFError>) in
