...
final class ApiDocDetails {

static func DocDetails(parameters:[String:Any] ,completion: @escaping ( Bool , ModelDocDetails?, String?) -> ()) {
    
    let url = URLs().DoctorDetails
    ...
    AF.request(url, method: .post,parameters: parameters ,encoding: JSONEncoding.default ,headers: header )
        ...
        .responseDecodable(completionHandler: { ( response : DataResponse<ModelDocDetails?, AFError>) in
