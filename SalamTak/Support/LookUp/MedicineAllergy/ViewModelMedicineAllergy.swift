...
class ViewModelMedicineAllergy: ObservableObject {
...
extension ViewModelMedicineAllergy:TargetType{
    var url: String{
        return URLs().GetMedicineAllergy
    }
    ...
    func startFetchMedicineAllergy() {
        if Helper.isConnectedToNetwork(){
            ...
            BaseNetwork.request(Target: self, responseModel: BaseResponse<[MedicineAllergy]>.self) { [self] (success, model, err) in
                if success{
                    //case of success
