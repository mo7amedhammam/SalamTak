...
//                                            Spacer().frame(height: 20)
//                                            Group{
//                                                InputTextField(text: $medicalUpdatedVM.OtherAllergies, errorMsg: .constant(""), title: "Other Allergies")
//                                            
//                                            Spacer().frame(height: 20)
//                                                InputTextField(text: $medicalUpdatedVM.Prescriptions, errorMsg: .constant(""), title: "Prescriptions")
//                                            
//                                            Spacer().frame(height: 20)
//                                                InputTextField(text: $medicalUpdatedVM.CurrentMedication, errorMsg: .constant(""), title: "CurrentMedication")
//                                                
//                                            }.focused($isfocused)
//                                                .environment(\.layoutDirection, language.rawValue == "en" ? .leftToRight : .rightToLeft)
...
//                                            Group{
//                                            Spacer().frame(height: 20)
//                                                InputTextField(text: $medicalUpdatedVM.PastMedication, errorMsg: .constant(""), title: "PastMedication")
//                                            Spacer().frame(height: 20)
//                                                
//                                                InputTextField(text: $medicalUpdatedVM.ChronicDiseases, errorMsg: .constant(""), title: "ChronicDiseases")
//                                            Spacer().frame(height: 20)
//                                                
//                                                InputTextField(text: $medicalUpdatedVM.Iinjuries, errorMsg: .constant(""), title: "Iinjuries")
//                                            Spacer().frame(height: 20)
//                                                
//                                                InputTextField(text: $medicalUpdatedVM.Surgeries, errorMsg: .constant(""), title: "Surgeries")
//                                        }.focused($isfocused)
//                                            .environment(\.layoutDirection, language.rawValue == "en" ? .leftToRight : .rightToLeft)
//                                            .autocapitalization(.none)
//                                            .textInputAutocapitalization(.never)
...
//                    if ShowBloodType {
//                        ShowUpdateBloodTypeList(ShowBloodType: $ShowBloodType, bounds: $bounds, offset: $offset)
//                            .environmentObject(medicalUpdatedVM)
//                            .environmentObject(BloodTypeVM)
//                        
//                    } else if ShowFoodAllergy{
//                        ShowUpdateFoodAllergyList(ShowFoodAllergy: $ShowFoodAllergy, bounds: $bounds, offset: $offset)
//                            .environmentObject(medicalUpdatedVM)
//                      
//                    } else if ShowMedicineAllergy{
//                        ShowUpdateMedicineAllergyList( ShowMedicineAllergy: $ShowMedicineAllergy, bounds: $bounds, offset: $offset)
//                            .environmentObject(medicalUpdatedVM)
//                    }
//                }
//                .onAppear(perform: {
